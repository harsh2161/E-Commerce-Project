...
const forgotPassword = (email) => async (dispatch) => {
    try
    {
        ...
        const response = new Promise((resolve, reject) => {
            fetch(
                `${process.env.REACT_APP_BACKEND_URL}password/forget`,
                "POST",
                email
            ).then(
                (res) => {
...
export { deleteUser, updateUser, getUserDetails, getAllUsers, login, clearErrors, registerUser, loadUser, logout, updateProfile, updatePassword, forgotPassword, resetPassword }